  ...
  <div class="course--catalog">
    <div class="course--chapter">
      <div
        ...
        class="chapter-item"
      >
        <div class="course--chapter__title" :data-id="chapter.id">
        ...
        <div
          ...
          :class="[
            ...
            section.id == section_id ? 'active' : ''
          ]"
        >
          <span v-if="!canLearn"
            >第 {{ sindex + 1 }} 节 {{ section.name }}</span
          >
          <router-link
            v-else
            :to="{
            ...
            >第 {{ sindex + 1 }} 节 {{ section.name }}
          </router-link>
        </div>
        <div v-if="false">
          <div
            :class="['course--homeworks__item']"
